...
const UserUpdate = ({ onAddTodo, darkMode }) => {
  ...
  const mutation = useMutation({
    mutationFn: (updatedTodo) =>
      api.patch(`users/update/${editId}`, updatedTodo),
    onSuccess: (res) => {
      // Invalidate and refetch
      queryClient.invalidateQueries({ queryKey: ["users"] });
      onClose();
      toast(res.data.message || "User Update successfully!", {
        position: "top-center",
        autoClose: 2000,
    ...
    <div className="relative">
      ...
      >
        ...
        >
          ...
          <AddButton className=" px-[100px] py-[18px]" title="Edit User" />
        </form>
